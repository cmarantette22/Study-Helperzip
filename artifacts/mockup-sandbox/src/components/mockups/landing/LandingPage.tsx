...
export function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans overflow-y-auto overflow-x-hidden selection:bg-indigo-500/30">
      {/* 1. Nav */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="h-14 px-8 text-base border-slate-700 text-slate-950 bg-white hover:bg-slate-100 rounded-full w-full sm:w-auto gap-2">
            ...
            {/* Mock UI */}
            <div className="relative mx-auto w-full max-w-md perspective-[2000px]">
              <div className="relative transform rotate-y-[-10deg] rotate-x-[5deg] shadow-2xl rounded-2xl border border-slate-800 bg-slate-900 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    {['Nucleus', 'Mitochondria', 'Ribosome', 'Golgi apparatus'].map((opt, i) => (
                      <div key={i} className={`p-4 rounded-xl border ${i === 2 ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-100' : 'bg-slate-800/50 border-slate-700 text-slate-300'} flex items-center gap-3 transition-colors`}>
                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${i === 2 ? 'border-emerald-500 bg-emerald-500 text-white' : 'border-slate-600'}`}>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="relative flex flex-col items-center text-center">
                {i !== 2 && <div className="hidden md:block absolute top-12 left-[60%] w-[80%] h-[2px] bg-indigo-100 border-t-2 border-dashed border-indigo-200"></div>}
      ...
      <section id="pricing" className="py-24 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
            ...
            {/* Annual */}
            <Card className="bg-gradient-to-b from-indigo-600 to-indigo-900 border-indigo-500 text-white transform md:scale-105 shadow-2xl shadow-indigo-900/50">
              <CardHeader>
